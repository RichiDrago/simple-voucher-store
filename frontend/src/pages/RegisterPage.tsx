...
// API
import { authRegisterApi } from "../api/auth";
...
const TRANSLATION_NAMESPACE = "pages.register";
...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const response = await authRegisterApi(username, password);
            ...
            <div className="w-full max-w-md space-y-8 rounded-xl bg-white px-8 py-10 shadow-lg">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-2">
                        <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700">
                            {t(`${TRANSLATION_NAMESPACE}.confirmPassword`)}
                        </label>
                        <input
                            id="confirmPassword"
                            type="password"
                ...
                <div className="flex items-center justify-center text-xs text-gray-500">
                    <div className="flex space-x-2">
                        <p>{t(`${TRANSLATION_NAMESPACE}.haveAccount`)}</p>
                        <button type="button" className="text-primary hover:text-primary-dark font-medium" onClick={handleGoToLogin}>
