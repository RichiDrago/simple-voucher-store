...
# Diagramma dell'Architettura Backend

Di seguito è rappresentata l’architettura logica del backend, basata su Express, Sequelize e una struttura modulare multilayer.
                           ...
                           │             DAL               │
                           │ Data Access Layer             │
                           │ Chiamate ai modelli ORM       │
                           └──────────────┬───────────────┘
                                          │
                                          ▼
                           ┌──────────────────────────────┐
                           │            MODELS             │
                           │   Sequelize ORM → Tabelle DB  │
                           └──────────────┬───────────────┘
                                          │
                                          ▼
                           ┌──────────────────────────────┐
